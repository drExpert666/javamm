...
public final class ConstantExpression implements Expression {
    ...
    /* кэширование - создали уже готовые объекты ConstantExpression, для наиболее часто используемых констант
    * для того чтобы не создавалосб лишнее количество объектов */
    ...
    /* делаем конструктор приватным, чтобы его не возможно было вызвать извне */
    ...
    /* создаём экземпляры ConstantExpression через статический метод valueOf() */
